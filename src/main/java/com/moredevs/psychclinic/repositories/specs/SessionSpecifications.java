...
public class SessionSpecifications {
    public static Specification<Session> withClientName() {
        return (Root<Session> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) -> {
            ...
            return criteriaBuilder.equal(root.get("psychologist").get("id"), criteriaBuilder.parameter(Integer.class, "psychologistId"));
        };
    }
}
